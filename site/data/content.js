export const pains = [
  ...
  { href: "#trace", en: ["Research → production", "A notebook and a checkpoint are not an operational handoff.", "Ship a package, resolved config, fingerprints and an explicit serving contract.", "Trace the run lineage", "What does a handoff artifact look like in your team today?"], uk: ["Research → production", "Ноутбук і checkpoint — це не операційна передача.", "Передавайте package, resolved config, fingerprints і явний serving contract.", "Пройти lineage запуску", "Як сьогодні виглядає handoff artifact у вашій команді?"] },
