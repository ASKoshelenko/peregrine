...
def main(argv: list[str] | None = None) -> int:
    ...
    fetch.add_argument("--destination", type=Path, default=Path("data/raw/warehouse-pallet-v1"))
    ...
    prepare.add_argument("--source", type=Path, default=Path("data/raw/warehouse-pallet-v1"))
